...
(define (problem p2)
  ...
  (:init (at f1 p1) (dec_f f3 f2) (dec_p p2 p1) (dec_p p3 p2) (dec_p p4 p3) (shaft e1 p2) (in e1 f1) (shaft e2 p3) (in e2 f1) (coin-at c1 f2 p1) (coin-at c2 f2 p1) (coin-at c3 f2 p2) (gate f2 p3))
  (:goal (and (have c2)))
)
(define (problem p2)
  (:domain elevators)
...
(define (problem p2-0-design)
 ...
 (at f1 p1) (dec_f f3 f2) (dec_p p2 p1) (dec_p p3 p2) (dec_p p4 p3) (shaft e1 p2) (in e1 f1) (shaft e2 p3) (in e2 f1) (coin-at c1 f2 p1) (coin-at c2 f2 p1) (coin-at c3 f2 p2) (gate f2 p3))
  (:goal (and (have c2)))
)
